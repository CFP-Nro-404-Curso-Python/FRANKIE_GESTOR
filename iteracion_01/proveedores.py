...
class Proveedor(tk.Toplevel):
    def __init__(self, parent):
        ...
        boton_guardar = tk.Button(self, text="Guardar Proveedor")
        boton_guardar.grid(row=3, column=3)

        boton_modificar = tk.Button(self, text="Modificar Proveedor")
        boton_modificar.grid(row=5, column=3)

        boton_eliminar = tk.Button(self, text="Eliminar Proveedor")
