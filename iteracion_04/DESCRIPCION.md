...
*   🧾 **Facturación (`facturacion_18.py`):** Nodo central de integración. Realiza validaciones matemáticas cruzadas, gestiona el archivo físico de stock en segundo plano y despliega interfaces de alerta
---
