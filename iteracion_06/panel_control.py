...
class PanelControl(tk.Toplevel):
    def __init__(self, parent, rol_usuario):
        ...
        def abrir_usuarios():
            # Futuro módulo de gestión de credenciales.
            # messagebox.showinfo("Módulo en Desarrollo", "Gestión de Usuarios se implementará pronto.")
            from usuarios import Usuario
            Usuario(self, rol_usuario)
            
        def abrir_consola():
            # Futuro módulo de Consola SQL.
            # messagebox.showinfo("Módulo en Desarrollo", "La Consola SQL de Solo Lectura se implementará pronto.")
        ...
        tk.Label(self, text=f"BIENVENIDO/A", font=("Arial", 16, "bold"), bg="#f0f2f5", fg="#333333").pack(pady=(20, 5))
