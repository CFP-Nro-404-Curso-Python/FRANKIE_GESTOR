    ...
    def __init__(self, parent, rol_actual):
        ...
        def cargar_datos_db():
            ...
            for fila in filas:
                ...
                tabla.insert("", "end", iid=fila[0], values=(fila[1], fila[2]))
            conexion.close()
        ...
        def modificar():
            ...
            try:
                ...
                if password:
                    cursor.execute("UPDATE usuarios SET usuario=?, password=?, rol=? WHERE id=?", 
        ...
        tk.Label(frame_form, text="Usuario:").grid(row=0, column=0, padx=10, pady=5, sticky="e")
        caja_usuario = tk.Entry(frame_form, width=25)
        caja_usuario.grid(row=0, column=1, padx=10, pady=5)

        tk.Label(frame_form, text="Contraseña:").grid(row=1, column=0, padx=10, pady=5, sticky="e")
        caja_password = tk.Entry(frame_form, width=25, show="*")
        caja_password.grid(row=1, column=1, padx=10, pady=5)

        tk.Label(frame_form, text="Rol Asignado:").grid(row=2, column=0, padx=10, pady=5, sticky="e")
        ...
        caja_rol.grid(row=2, column=1, padx=10, pady=5)
